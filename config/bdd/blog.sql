...
INSERT INTO `article` (`id`, `title`, `author`, `content`, `createdAt`, `updatedAt`)
VALUES (1, 'Bienvenue sur mon blog !', '',
       ...
       (2, 'Le PHP à la conquête du monde !', '',
       ...
       (3, 'test', 'Loly', 'test', '2020-06-03 11:51:04', '2020-06-03 11:51:04');
...
INSERT INTO `comment` (`id`, `articleId`, `author`, `content`, `createdAt`, `updatedAt`)
VALUES (1, 1, 'M@teo21', 'Un peu court ce billet !', '2010-03-25 16:49:53', '2020-03-18 11:05:41'),
       ...
       (5, 2, 'Maxime', 'Excellente analyse de la situation !\r\nIl y arrivera plus tôt qu\'on ne le pense !',
        '2010-03-27 22:02:13', '2020-03-18 11:05:41'),
...
VALUES (1, 'Loly', '$argon2id$v=19$m=65536,t=4,p=1$b1c3Mkw1QVIvc1Q0ay5lNw$Va9azRXMlL1sQ0zZgEsOEPUCTRuJz2rDx8xrOOrxbTg',
        'loly909@hotmail.fr', 'admin', '2020-05-27 12:19:04', '2020-05-27 12:19:04'),
       (2, 'Plop', '$argon2id$v=19$m=65536,t=4,p=1$TEpkZFJULlBMcU9TOXplYw$K7PeeQQOwSpIpGO4OyZkU7xhwaoZqlmdcQyL0A4q8ps',
        'plop@hotmail.fr', 'user', '2020-06-03 10:51:25', '2020-06-03 10:51:25');
