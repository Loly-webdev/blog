...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  jeu. 08 oct. 2020 à 07:34
...
INSERT INTO `article` (`id`, `title`, `author`, `hat`, `content`, `createdAt`, `updatedAt`)
VALUES (1, 'Bienvenue sur mon blog !', 'LolyWD', 'Bienvenue sur mon blog !',
        'Je vous souhaite à toutes et à tous la bienvenue sur mon blog qui parlera de... PHP bien sûr !',
        '2010-03-25 16:28:41', '2020-03-18 11:06:28'),
       (2, 'Le PHP à la conquête du monde !', 'Nowhere',
        'L\'éléphant l\'a annoncé, il a l\'intention de conquérir le monde !',
        ...
        '2010-03-27 18:31:11', '2020-03-18 11:06:28'),
...
INSERT INTO `comment` (`id`, `approved`, `articleId`, `author`, `content`, `createdAt`, `updatedAt`)
VALUES (1, 'oui', 1, 'M@teo21', 'Un peu court ce billet !', '2010-03-25 16:49:53', '2020-03-18 11:05:41'),
       (2, 'oui', 1, 'Maxime', 'Oui, ça commence pas très fort ce blog...', '2010-03-25 16:57:16',
        '2020-03-18 11:05:41'),
       ...
       (5, 'oui', 2, 'Maxime', 'Excellente analyse de la situation !\r\nIl y arrivera plus tôt qu\'on ne le pense !',
        '2010-03-27 22:02:13', '2020-08-31 16:06:14'),
...
INSERT INTO `user` (`id`, `login`, `password`, `mail`, `role`, `createdAt`, `updatedAt`)
VALUES (1, 'Loly', '$argon2id$v=19$m=65536,t=4,p=1$d0cwdVRER0FvS3dEbU94UA$UjL5NYDe2Od6m10VlfoGFT2E70i38THCZc3Ph/w5Zvk',
        'eloise.ruiz.rodriguez@gmail.com', 'admin', '2020-10-01 10:44:47', '2020-10-01 08:44:47'),
       (2, 'Plop', '$argon2id$v=19$m=65536,t=4,p=1$aTVwdTIvOE5ScDNUZTNlcg$xO19hcH6hYnUn6FUzDXfjvBADA5zmN4dDTmnDOnFW00',
        'loly909@hotmail.fr', '', '2020-09-19 10:57:45', '2020-09-19 08:57:45');
